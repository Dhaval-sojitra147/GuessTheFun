            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(child: Text(AppConstants.disclaimer,style: TextStyleConstant.textBold28(color: ColorConstants.purpleColor.withOpacity(0.9)),)),
                ),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(child: Text(AppConstants.disclaimerDetail.tr,style: TextStyleConstant.textBold24(color: ColorConstants.black.withOpacity(0.6)),textAlign: TextAlign.center,))
                ),
              ),
              ...
              GestureDetector(
                  onTap: () async {
                    ...
                    SharedPref().setBoolToSF(StorageConstants.readDisclaimer, true);
                  },
